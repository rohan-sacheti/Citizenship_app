...
// Official USCIS 100 Civics Questions (2008 Version)
// Questions marked with * are for 65/20 eligibility (65 years or older with 20+ years as LPR)
...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answers: ['(Answers will vary based on your state)'],
    category: 'American Government',
    subcategory: 'System of Government',
    isAsterisk: true,
    isDynamicAnswer: true,
    dynamicField: 'senator',
  },
  {
    id: 21,
  ...
  },
  {
    ...
    answers: ['(Answers will vary based on your congressional district)'],
    category: 'American Government',
    subcategory: 'System of Government',
    isAsterisk: false,
    isDynamicAnswer: true,
    dynamicField: 'representative',
  },
  {
    id: 24,
  ...
  },
  {
    ...
    answers: ['Joe Biden', 'Biden'],
    category: 'American Government',
    subcategory: 'System of Government',
    isAsterisk: true,
    isDynamicAnswer: true,
    dynamicField: 'president',
  },
  {
    id: 29,
    question: 'What is the name of the Vice President of the United States now?',
    answers: ['Kamala Harris', 'Harris'],
    category: 'American Government',
    subcategory: 'System of Government',
    isAsterisk: true,
    isDynamicAnswer: true,
    dynamicField: 'vicePresident',
  },
  {
    id: 30,
